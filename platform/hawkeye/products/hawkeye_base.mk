...
# _product_private_path is cleared in hawkeye_ product makefiles
_product_private_path := vendor/nvidia/hawkeye
...
PRODUCT_COPY_FILES += \
    ...
    device/nvidia/platform/hawkeye/nvaudio_conf.xml:system/etc/nvaudio_conf.xml \
    device/nvidia/platform/hawkeye/nvaudio_conf_pdm1.xml:system/etc/nvaudio_conf_pdm1.xml \
    device/nvidia/platform/hawkeye/nvaudio_factory_conf.xml:system/etc/nvaudio_factory_conf.xml \
    device/nvidia/platform/hawkeye/nvaudio_factory_conf_pdm1.xml:system/etc/nvaudio_factory_conf_pdm1.xml \
    device/nvidia/platform/hawkeye/nvaudio_fx.xml:system/etc/nvaudio_fx.xml \
    device/nvidia/platform/hawkeye/audio_effects.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects.conf \
    ...
    $(call add-to-product-copy-files-if-exists, vendor/nvidia/hawkeye/utils/cyload/cyupdate_config.sh:$(TARGET_COPY_OUT_VENDOR)/bin/cyupdate_config.sh)
...
PRODUCT_COPY_FILES += \
    device/nvidia/platform/hawkeye/audio_policy.conf:system/etc/audio_policy.conf
else
PRODUCT_COPY_FILES += \
    device/nvidia/platform/hawkeye/audio_policy_noenhance.conf:system/etc/audio_policy.conf
endif
...
## default assets file
PRODUCT_COPY_FILES += \
    device/nvidia/platform/hawkeye/products/bitmap/charged.png:root/res/images/charger/charged.png \
    device/nvidia/platform/hawkeye/products/bitmap/charging.png:root/res/images/charger/charging.png \
    device/nvidia/platform/hawkeye/products/bitmap/fullycharged.png:root/res/images/charger/fullycharged.png \
    device/nvidia/platform/hawkeye/products/bitmap/lowbat.png:root/res/images/charger/lowbat.png

TARGET_SYSTEM_PROP    += device/nvidia/platform/hawkeye/system.prop

# Empty UDA image
PRODUCT_COPY_FILES += \
    device/nvidia/platform/hawkeye/products/empty_userdata_32g.img:userdata32.img
...
LOCAL_FW_XML_PATH=vendor/nvidia/hawkeye/sku
