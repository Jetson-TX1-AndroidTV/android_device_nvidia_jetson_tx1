...
SKU_DARCY = "Darcy"
SKU_HAWKEYE = "Hawkeye"
SKU_HAWKEYE_A04_DVT = "Hawkeye A04 (DVT)"
SKU_HAWKEYE_A04_MP = "Hawkeye A04 (MP)"
...
def detect_sku():
    ...
    elif "hawkeye-p2290-3304-a04" in ret:
        SKU_ON_DEVICE = SKU_HAWKEYE_A04_DVT
    elif "hawkeye-p2290-3306-a04" in ret:
        SKU_ON_DEVICE = SKU_HAWKEYE_A04_MP
    elif "hawkeye" in ret:
        SKU_ON_DEVICE = SKU_HAWKEYE
    else:
        return False
